...
-- Started on 2026-04-29 16:00:01
...
--
-- TOC entry 235 (class 1259 OID 37541)
-- Name: dokumen_transaksi; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.dokumen_transaksi (
    id integer NOT NULL,
    transaksi_id integer NOT NULL,
    nama_file character varying(255) NOT NULL,
    path_file character varying(512) NOT NULL,
    tipe_file character varying(20) NOT NULL,
    ukuran_file bigint,
    created_at timestamp without time zone
);


ALTER TABLE public.dokumen_transaksi OWNER TO postgres;

--
-- TOC entry 234 (class 1259 OID 37540)
-- Name: dokumen_transaksi_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.dokumen_transaksi_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.dokumen_transaksi_id_seq OWNER TO postgres;

--
-- TOC entry 4957 (class 0 OID 0)
-- Dependencies: 234
-- Name: dokumen_transaksi_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.dokumen_transaksi_id_seq OWNED BY public.dokumen_transaksi.id;
...
--
-- TOC entry 233 (class 1259 OID 37524)
-- Name: status_layanan_log; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.status_layanan_log (
    id integer NOT NULL,
    kecamatan_id integer NOT NULL,
    user_id integer NOT NULL,
    status_sebelum boolean NOT NULL,
    status_sesudah boolean NOT NULL,
    alasan character varying(255),
    created_at timestamp without time zone
);


ALTER TABLE public.status_layanan_log OWNER TO postgres;

--
-- TOC entry 232 (class 1259 OID 37523)
-- Name: status_layanan_log_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.status_layanan_log_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.status_layanan_log_id_seq OWNER TO postgres;

--
-- TOC entry 4959 (class 0 OID 0)
-- Dependencies: 232
-- Name: status_layanan_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.status_layanan_log_id_seq OWNED BY public.status_layanan_log.id;
...
--
-- TOC entry 4745 (class 2604 OID 37459)
...
--
-- TOC entry 4744 (class 2604 OID 37447)
...
--
-- TOC entry 4743 (class 2604 OID 29070)
...
--
-- TOC entry 4747 (class 2604 OID 37544)
-- Name: dokumen_transaksi id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dokumen_transaksi ALTER COLUMN id SET DEFAULT nextval('public.dokumen_transaksi_id_seq'::regclass);


--
-- TOC entry 4739 (class 2604 OID 29016)
...
--
-- TOC entry 4746 (class 2604 OID 37527)
-- Name: status_layanan_log id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.status_layanan_log ALTER COLUMN id SET DEFAULT nextval('public.status_layanan_log_id_seq'::regclass);


--
-- TOC entry 4741 (class 2604 OID 29039)
...
--
-- TOC entry 4742 (class 2604 OID 29053)
...
--
-- TOC entry 4740 (class 2604 OID 29025)
...
--
-- TOC entry 4940 (class 0 OID 29084)
-- Dependencies: 227
...
--
-- TOC entry 4944 (class 0 OID 37456)
-- Dependencies: 231
...
2	backup_domba_20260414_160000.sql	33035	backups\\backup_domba_20260414_160000.sql	sql	VERIFIED	BACKUP	\N	2026-04-14 16:00:00.508569	\N
3	backup_domba_20260414_160000.sql	33035	backups\\backup_domba_20260414_160000.sql	sql	VERIFIED	BACKUP	\N	2026-04-14 16:00:00.57563	\N
\.


--
-- TOC entry 4942 (class 0 OID 37444)
-- Dependencies: 229
...
--
-- TOC entry 4939 (class 0 OID 29067)
-- Dependencies: 226
...
10	3298789789789798	DEWI	2026-04-28 12:10:24.278086	t	2026-04-28 12:11:15.18059	DEWI	1	1	Yang Bersangkutan	BERHASIL	\N	Rusak	t
\.


--
-- TOC entry 4948 (class 0 OID 37541)
-- Dependencies: 235
-- Data for Name: dokumen_transaksi; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.dokumen_transaksi (id, transaksi_id, nama_file, path_file, tipe_file, ukuran_file, created_at) FROM stdin;
\.


--
-- TOC entry 4931 (class 0 OID 29013)
-- Dependencies: 218
-- Data for Name: kecamatan; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.kecamatan (id, nama_kecamatan, kode_wilayah, latitude, longitude, is_active) FROM stdin;
2	Kecamatan Garut Kota	32.05.01	\N	\N	\N
3	Kecamatan Tarogong Kidul	32.05.02	\N	\N	\N
44	Kecamatan Wanaraja	32.05.42	\N	\N	\N
5	Kecamatan Banjarwangi	32.05.03	\N	\N	\N
6	Kecamatan Banyuresmi	32.05.04	\N	\N	\N
7	Kecamatan Bayongbong	32.05.05	\N	\N	\N
8	Kecamatan Blubur Limbangan	32.05.06	\N	\N	\N
9	Kecamatan Bungbulang	32.05.07	\N	\N	\N
10	Kecamatan Caringin	32.05.08	\N	\N	\N
11	Kecamatan Cibalong	32.05.09	\N	\N	\N
12	Kecamatan Cibatu	32.05.10	\N	\N	\N
13	Kecamatan Cibiuk	32.05.11	\N	\N	\N
14	Kecamatan Cigedug	32.05.12	\N	\N	\N
15	Kecamatan Cihurip	32.05.13	\N	\N	\N
16	Kecamatan Cikajang	32.05.14	\N	\N	\N
17	Kecamatan Cikelet	32.05.15	\N	\N	\N
18	Kecamatan Cilawu	32.05.16	\N	\N	\N
19	Kecamatan Cisewu	32.05.17	\N	\N	\N
20	Kecamatan Cisompet	32.05.18	\N	\N	\N
21	Kecamatan Cisurupan	32.05.19	\N	\N	\N
22	Kecamatan Kadungora	32.05.20	\N	\N	\N
23	Kecamatan Karangpawitan	32.05.21	\N	\N	\N
24	Kecamatan Karangtengah	32.05.22	\N	\N	\N
25	Kecamatan Kersamanah	32.05.23	\N	\N	\N
26	Kecamatan Leles	32.05.24	\N	\N	\N
27	Kecamatan Leuwigoong	32.05.25	\N	\N	\N
28	Kecamatan Malangbong	32.05.26	\N	\N	\N
29	Kecamatan Mekarmukti	32.05.27	\N	\N	\N
30	Kecamatan Pakenjeng	32.05.28	\N	\N	\N
31	Kecamatan Pameungpeuk	32.05.29	\N	\N	\N
32	Kecamatan Pamulihan	32.05.30	\N	\N	\N
33	Kecamatan Pangatikan	32.05.31	\N	\N	\N
34	Kecamatan Pasirwangi	32.05.32	\N	\N	\N
35	Kecamatan Peundeuy	32.05.33	\N	\N	\N
36	Kecamatan Samarang	32.05.34	\N	\N	\N
37	Kecamatan Selaawi	32.05.35	\N	\N	\N
38	Kecamatan Singajaya	32.05.36	\N	\N	\N
39	Kecamatan Sucinaraja	32.05.37	\N	\N	\N
40	Kecamatan Sukaresmi	32.05.38	\N	\N	\N
41	Kecamatan Sukawening	32.05.39	\N	\N	\N
42	Kecamatan Talegong	32.05.40	\N	\N	\N
43	Kecamatan Tarogong Kaler	32.05.41	\N	\N	\N
1	Dinas	32.05.00	\N	\N	\N
\.


--
-- TOC entry 4946 (class 0 OID 37524)
-- Dependencies: 233
-- Data for Name: status_layanan_log; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.status_layanan_log (id, kecamatan_id, user_id, status_sebelum, status_sesudah, alasan, created_at) FROM stdin;
\.


--
-- TOC entry 4935 (class 0 OID 29036)
-- Dependencies: 222
...
25	26	247	0	2026-04-28 12:14:02.010676
1	1	3797	0	2026-04-29 12:20:35.408352
\.


--
-- TOC entry 4937 (class 0 OID 29050)
-- Dependencies: 224
...
31	1	1	CETAK	1	0	2026-04-28 12:10:24.299782	\N
32	1	1	IN_FROM_PUSAT	2000	0	2026-04-28 12:13:21.013206	
33	26	1	DISTRIBUSI_TO_KEC	50	0	2026-04-28 12:14:02.011561	\N
\.


--
-- TOC entry 4933 (class 0 OID 29022)
-- Dependencies: 220
...
1	administrator	pbkdf2:sha256:600000$ayr165euzVhrhlha$e796ddd5d02a38d4c0253563d667f3fa4f08e145f14d067c5ae3ad1747528435	admin_dinas	1	2026-04-29 14:26:32.24874	RIZKI ADE MAULANA	\N
...
SELECT pg_catalog.setval('public.backup_log_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.detail_cetak_id_seq', 10, true);


--
-- TOC entry 4966 (class 0 OID 0)
-- Dependencies: 234
-- Name: dokumen_transaksi_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.dokumen_transaksi_id_seq', 1, false);
...
-- Dependencies: 232
-- Name: status_layanan_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.status_layanan_log_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.transaksi_id_seq', 35, true);
...
--
-- TOC entry 4765 (class 2606 OID 29088)
...
--
-- TOC entry 4769 (class 2606 OID 37463)
...
--
-- TOC entry 4767 (class 2606 OID 37449)
...
--
-- TOC entry 4763 (class 2606 OID 29072)
...
--
-- TOC entry 4773 (class 2606 OID 37548)
-- Name: dokumen_transaksi dokumen_transaksi_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dokumen_transaksi
    ADD CONSTRAINT dokumen_transaksi_pkey PRIMARY KEY (id);


--
-- TOC entry 4749 (class 2606 OID 29020)
...
--
-- TOC entry 4751 (class 2606 OID 29018)
...
--
-- TOC entry 4771 (class 2606 OID 37529)
-- Name: status_layanan_log status_layanan_log_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.status_layanan_log
    ADD CONSTRAINT status_layanan_log_pkey PRIMARY KEY (id);


--
-- TOC entry 4757 (class 2606 OID 29043)
...
--
-- TOC entry 4759 (class 2606 OID 29041)
...
--
-- TOC entry 4761 (class 2606 OID 29055)
...
--
-- TOC entry 4753 (class 2606 OID 29027)
...
--
-- TOC entry 4755 (class 2606 OID 29029)
...
--
-- TOC entry 4781 (class 2606 OID 37464)
...
--
-- TOC entry 4780 (class 2606 OID 37450)
...
--
-- TOC entry 4778 (class 2606 OID 29078)
...
--
-- TOC entry 4779 (class 2606 OID 29073)
...
--
-- TOC entry 4784 (class 2606 OID 37549)
-- Name: dokumen_transaksi dokumen_transaksi_transaksi_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dokumen_transaksi
    ADD CONSTRAINT dokumen_transaksi_transaksi_id_fkey FOREIGN KEY (transaksi_id) REFERENCES public.transaksi(id);


--
-- TOC entry 4782 (class 2606 OID 37530)
-- Name: status_layanan_log status_layanan_log_kecamatan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.status_layanan_log
    ADD CONSTRAINT status_layanan_log_kecamatan_id_fkey FOREIGN KEY (kecamatan_id) REFERENCES public.kecamatan(id);


--
-- TOC entry 4783 (class 2606 OID 37535)
-- Name: status_layanan_log status_layanan_log_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.status_layanan_log
    ADD CONSTRAINT status_layanan_log_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id);


--
-- TOC entry 4775 (class 2606 OID 29044)
...
--
-- TOC entry 4776 (class 2606 OID 29056)
...
--
-- TOC entry 4777 (class 2606 OID 29061)
...
--
-- TOC entry 4774 (class 2606 OID 29030)
...
-- Completed on 2026-04-29 16:00:01
